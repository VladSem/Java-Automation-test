 ...
 */
public class Modem_3_Test extends AvenirWebDriver {

    private ModemsPattern modemsPattern = new ModemsPattern();

    private String modem = "Modem #3";
    ...
    //private String buttonConfig = "//tr[5]/td[9]/a";
    private String buttonConfig = "html/body/div[4]/center/div/table/tbody/tr[5]/td[9]/a[1]";
    //private String buttonTerminate = "//tr[5]/td[9]/a";
    //private String buttonTerminate = "html/body/div[4]/center/div/table/tbody/tr[5]/td[9]/a[1]";
    private String buttonTerminate = "html/body/div[4]/center/div/table/tbody/tr[5]/td[9]/a[1]";
    private String buttonReconnect = "//tr[5]/td[9]/a[2]";
    ...
    private String pathToSimCardDetection = "html/body/div[4]/center/div/table/tbody/tr[6]/td[3]/span";

    private String pathToCarrierDetection = "html/body/div[4]/center/div/table/tbody/tr[6]/td[3]/font[1]";

    private String pathToConnectedBandDetection = "html/body/div[4]/center/div/table/tbody/tr[6]/td[3]/font[2]";

    private String pathToNetworkDetection = "html/body/div[4]/center/div/table/tbody/tr[6]/td[3]/font[3]";

    private String pathToCSQdetection = "//tr[6]/td[contains(text(),'last')]";

    private String pathToModemConnectionButton = "html/body/div[4]/center/div/table/tbody/tr[5]/td[8]";

    Modem_Reconnect modem_reconnect = new Modem_Reconnect();
    private String pathToReconnectButton = "html/body/div[4]/center/div/table/tbody/tr[5]/td[9]/a[2]";
